...
import { MAIN_ROUTERS } from "@/constants/routers";
...
const LogoSection = () => {
  return (
    <a href="https://flowbite.com" className="flex p-4">
      <img
...
const CustomMainRouter = () => {
  return (
    <ul className="space-y-2 font-medium">
      {MAIN_ROUTERS.map((router, index: number) => {
        return (
          <li key={index}>
            <a
              href={router.href}
            ...
            >
              {router.icon}
              <span className="ms-3">{router.name}</span>
            </a>
          </li>
        );
      })}
